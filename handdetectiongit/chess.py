...
bp = Piece('b', 'p', './Desktop/handchess/handdetectiongit/bP.png')
wp = Piece('w', 'p', './Desktop/handchess/handdetectiongit/wP.png')
bk = Piece('b', 'k', './Desktop/handchess/handdetectiongit/bQ.png')
wk = Piece('w', 'k', './Desktop/handchess/handdetectiongit/wQ.png')
br = Piece('b', 'r', './Desktop/handchess/handdetectiongit/bR.png')
wr = Piece('w', 'r', './Desktop/handchess/handdetectiongit/wR.png')
bb = Piece('b', 'b', './Desktop/handchess/handdetectiongit/bB.png')
wb = Piece('w', 'b', './Desktop/handchess/handdetectiongit/wB.png')
bq = Piece('b', 'q', './Desktop/handchess/handdetectiongit/bK.png')
wq = Piece('w', 'q', './Desktop/handchess/handdetectiongit/wK.png')
bkn = Piece('b', 'kn', './Desktop/handchess/handdetectiongit/bN.png')
wkn = Piece('w', 'kn', './Desktop/handchess/handdetectiongit/wN.png')
...
def create_board(board):
    board[0] = [Piece('b', 'r', './Desktop/handchess/handdetectiongit/bR.png'), Piece('b', 'kn', 'bK.png'), Piece('b', 'b', 'bP.png'), \
               Piece('b', 'q', './Desktop/handchess/handdetectiongit/bQ.png'), Piece('b', 'k', 'bK.png'), Piece('b', 'b', 'bB.png'), \
               Piece('b', 'kn', './Desktop/handchess/handdetectiongit/bN.png'), Piece('b', 'r', 'bR.png')]

    board[7] = [Piece('w', 'r', './Desktop/handchess/handdetectiongit/wR.png'), Piece('w', 'kn', './Desktop/handchess/handdetectiongit/wK.png'), Piece('w', 'b', './Desktop/handchess/handdetectiongit/wP.png'), \
               Piece('w', 'q', './Desktop/handchess/handdetectiongit/wQ.png'), Piece('w', 'k', './Desktop/handchess/handdetectiongit/wK.png'), Piece('w', 'b', './Desktop/handchess/handdetectiongit/wB.png'), \
               Piece('w', 'kn', './Desktop/handchess/handdetectiongit/wN.png'), Piece('w', 'r', './Desktop/handchess/handdetectiongit/wR.png')]

    for i in range(8):
        board[1][i] = Piece('b', 'p', 'bP.png')
        board[6][i] = Piece('w', 'p', 'wP.png')
    return board
